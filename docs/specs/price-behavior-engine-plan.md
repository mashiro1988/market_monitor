...
> **状态：spec 已定稿（`docs/specs/volume-behavior-engine-discussion.md` v0.4，2026-07-09 用户确认复盘流），待开工。** 待定项仅剩 config 数值拍板（见「仅剩待定」）。
...
1. **T_ref 三档 config 数值圆整拍板**（含 CL/N225/US2Y 三个还没实测反解的资产——Task 9 校准脚本产出后用户拍）。
